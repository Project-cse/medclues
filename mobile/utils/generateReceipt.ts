...
<body>
  ...
  <div class="section">
    ...
    <div class="row"><span class="label">Hospital</span><span class="value">${esc(appointment.hospital_name ?? "MedClues Network")}</span></div>
  </div>
  <div class="section">
  ...
  <div class="footer">
    <p>Thank you for choosing MedClues</p>
