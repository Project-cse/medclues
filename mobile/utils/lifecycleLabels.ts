/**
 * Shared lifecycle display labels for Expo patient UI.
 * Prefer lifecycleStatus over legacy status. Display only.
 */
...
export function labelForLifecycle(status?: string | null): string {
