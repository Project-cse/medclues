...
abstract class AppLocalizations {
  ...
  ///
  /// In en, this message translates to:
  /// **'Search doctors, hospitals, labs, and specialities.'**
  ...
  ///
  /// In en, this message translates to:
  /// **'Browse specialists and book a visit in a few taps.'**
  ...
  ///
  /// In en, this message translates to:
  /// **'One-tap access when every second counts.'**
  ...
  /// No description provided for @recordsTabHealth.
  ///
  /// In en, this message translates to:
  /// **'My Health Records'**
  String get recordsTabHealth;
  ...
  /// No description provided for @recordsPrescriptionsSubtitle.
  ///
  /// In en, this message translates to:
  /// **'Previous visits with your doctor'**
  String get recordsPrescriptionsSubtitle;

  /// No description provided for @recordsPrescriptionsEmpty.
  ///
  /// In en, this message translates to:
  /// **'No consultation prescriptions yet'**
  String get recordsPrescriptionsEmpty;

  /// No description provided for @recordsPrescriptionsEmptyHint.
  ///
  /// In en, this message translates to:
  /// **'Prescriptions from completed visits will appear here'**
  String get recordsPrescriptionsEmptyHint;

  /// No description provided for @recordsPrescriptionDetail.
  ///
  /// In en, this message translates to:
  /// **'Prescription Details'**
  String get recordsPrescriptionDetail;

  /// No description provided for @recordsDiagnosis.
  ///
  /// In en, this message translates to:
  /// **'Diagnosis'**
  String get recordsDiagnosis;

  /// No description provided for @recordsAdvice.
  ///
  /// In en, this message translates to:
  /// **'Advice'**
  String get recordsAdvice;

  /// No description provided for @recordsFollowUp.
  ///
  /// In en, this message translates to:
  /// **'Follow-up'**
  String get recordsFollowUp;

  /// No description provided for @recordsTablets.
  ///
  /// In en, this message translates to:
  /// **'Medications'**
  String get recordsTablets;

  /// No description provided for @recordsNoPrescriptionYet.
  ///
  /// In en, this message translates to:
  /// **'Prescription not yet added by your doctor'**
  String get recordsNoPrescriptionYet;

  /// No description provided for @todayAppointmentsTitle.
  ///
  /// In en, this message translates to:
  /// **'Today\'s Appointments'**
  String get todayAppointmentsTitle;

  /// No description provided for @todayAppointmentsCount.
  ///
  /// In en, this message translates to:
  /// **'{count} today'**
  String todayAppointmentsCount(int count);

  /// No description provided for @todayAppointmentsNext.
  ///
  /// In en, this message translates to:
  /// **'Next up'**
  String get todayAppointmentsNext;

  /// No description provided for @todayAppointmentsViewAll.
  ///
  /// In en, this message translates to:
  /// **'View all'**
  String get todayAppointmentsViewAll;
  ...
  /// No description provided for @statusReadyForDoctor.
  ///
  /// In en, this message translates to:
  /// **'Ready for doctor'**
  String get statusReadyForDoctor;
  ...
  /// No description provided for @statusDoctorOnBreak.
  ///
  /// In en, this message translates to:
  /// **'Doctor on Break'**
  ...
  /// No description provided for @queuePatientsAhead.
  ///
  /// In en, this message translates to:
  /// **'{count} ahead'**
  String queuePatientsAhead(int count);

  /// No description provided for @queueYourTurnNext.
  ///
  /// In en, this message translates to:
  /// **'Your turn is next — please proceed to the clinic'**
  String get queueYourTurnNext;
  ...
  /// No description provided for @queueLive.
  ///
  /// In en, this message translates to:
  /// **'Live Queue'**
  String get queueLive;

  /// No description provided for @queueInactive.
  ///
  /// In en, this message translates to:
  /// **'Queue not active for this visit'**
  String get queueInactive;

  /// No description provided for @pharmacyNoMapped.
  ///
  /// In en, this message translates to:
  /// **'No pharmacy mapped for this hospital yet'**
  String get pharmacyNoMapped;

  /// No description provided for @pharmacyNotLinked.
  ///
  /// In en, this message translates to:
  /// **'No pharmacy linked to this hospital'**
  String get pharmacyNotLinked;

  /// No description provided for @pharmacyNoBillsYet.
  ///
  /// In en, this message translates to:
  /// **'No pharmacy bills or payments yet.'**
  String get pharmacyNoBillsYet;
  ...
  /// No description provided for @hpImproveScore.
  ///
  /// In en, this message translates to:
  /// **'Improve your score'**
  String get hpImproveScore;

  /// No description provided for @hpEligibility.
  ///
  /// In en, this message translates to:
  /// **'Eligibility'**
  String get hpEligibility;
  ...
  /// No description provided for @hpFamilyCovered.
  ///
  /// In en, this message translates to:
  /// **'Family covered: {count}'**
  String hpFamilyCovered(int count);

  /// No description provided for @hpRiskLabel.
  ///
  /// In en, this message translates to:
  /// **'Risk: {risk}'**
  String hpRiskLabel(String risk);

  /// No description provided for @hpEmergencyCardQuick.
  ///
  /// In en, this message translates to:
  /// **'Quick view — Emergency Card'**
  String get hpEmergencyCardQuick;

  /// No description provided for @hpRemind.
  ///
  /// In en, this message translates to:
  /// **'Remind'**
  String get hpRemind;

  /// No description provided for @hpRenew.
  ///
  /// In en, this message translates to:
  /// **'Renew'**
  String get hpRenew;

  /// No description provided for @hpRetry.
  ///
  /// In en, this message translates to:
  /// **'Retry'**
  String get hpRetry;

  /// No description provided for @hpRenewalReminderSent.
  ///
  /// In en, this message translates to:
  /// **'Renewal reminder sent'**
  String get hpRenewalReminderSent;

  /// No description provided for @hpCompareTitle.
  ///
  /// In en, this message translates to:
  /// **'Compare plans'**
  String get hpCompareTitle;

  /// No description provided for @hpCompareNeedTwo.
  ///
  /// In en, this message translates to:
  /// **'Select at least 2 plans'**
  String get hpCompareNeedTwo;

  /// No description provided for @hpRecommendTitle.
  ///
  /// In en, this message translates to:
  /// **'AI Plan Recommendations'**
  String get hpRecommendTitle;

  /// No description provided for @hpEligibilityTitle.
  ///
  /// In en, this message translates to:
  /// **'Eligibility'**
  String get hpEligibilityTitle;

  /// No description provided for @hpCompareAction.
  ///
  /// In en, this message translates to:
  /// **'Compare'**
  String get hpCompareAction;

  /// No description provided for @hpCompareField.
  ///
  /// In en, this message translates to:
  /// **'Field'**
  String get hpCompareField;

  /// No description provided for @hpAiPick.
  ///
  /// In en, this message translates to:
  /// **'AI pick: {plan} — {reason}'**
  String hpAiPick(String plan, String reason);

  /// No description provided for @hpAge.
  ///
  /// In en, this message translates to:
  /// **'Age'**
  String get hpAge;

  /// No description provided for @hpMonthlyIncome.
  ///
  /// In en, this message translates to:
  /// **'Monthly income'**
  String get hpMonthlyIncome;

  /// No description provided for @hpStateCity.
  ///
  /// In en, this message translates to:
  /// **'State / City'**
  String get hpStateCity;

  /// No description provided for @hpStudent.
  ///
  /// In en, this message translates to:
  /// **'Student'**
  String get hpStudent;

  /// No description provided for @hpCorporateCover.
  ///
  /// In en, this message translates to:
  /// **'Corporate cover'**
  String get hpCorporateCover;

  /// No description provided for @hpCheckEligibility.
  ///
  /// In en, this message translates to:
  /// **'Check eligibility'**
  String get hpCheckEligibility;

  /// No description provided for @hpPolicyAnalyzer.
  ///
  /// In en, this message translates to:
  /// **'Policy Analyzer'**
  String get hpPolicyAnalyzer;

  /// No description provided for @hpClaims.
  ///
  /// In en, this message translates to:
  /// **'Claims'**
  String get hpClaims;

  /// No description provided for @hpNewClaim.
  ///
  /// In en, this message translates to:
  /// **'New claim'**
  String get hpNewClaim;

  /// No description provided for @hpNoClaimsYet.
  ///
  /// In en, this message translates to:
  /// **'No claims yet'**
  String get hpNoClaimsYet;

  /// No description provided for @hpClaimNumber.
  ///
  /// In en, this message translates to:
  /// **'Claim #{id}'**
  String hpClaimNumber(String id);

  /// No description provided for @hpClaimStatus.
  ///
  /// In en, this message translates to:
  /// **'Status: {status}'**
  String hpClaimStatus(String status);

  /// No description provided for @hpExpectedSettlement.
  ///
  /// In en, this message translates to:
  /// **'Expected settlement: {date}'**
  String hpExpectedSettlement(String date);

  /// No description provided for @hpUploadDocuments.
  ///
  /// In en, this message translates to:
  /// **'Upload documents'**
  String get hpUploadDocuments;

  /// No description provided for @hpSubmitClaim.
  ///
  /// In en, this message translates to:
  /// **'Submit claim'**
  String get hpSubmitClaim;

  /// No description provided for @hpTimeline.
  ///
  /// In en, this message translates to:
  /// **'Timeline'**
  String get hpTimeline;

  /// No description provided for @hpCashlessHospitals.
  ///
  /// In en, this message translates to:
  /// **'Cashless hospitals'**
  String get hpCashlessHospitals;

  /// No description provided for @hpCall.
  ///
  /// In en, this message translates to:
  /// **'Call'**
  String get hpCall;

  /// No description provided for @hpDirections.
  ///
  /// In en, this message translates to:
  /// **'Directions'**
  String get hpDirections;

  /// No description provided for @hpBook.
  ///
  /// In en, this message translates to:
  /// **'Book'**
  String get hpBook;

  /// No description provided for @hpAddFamilyMember.
  ///
  /// In en, this message translates to:
  /// **'Add family member'**
  String get hpAddFamilyMember;

  /// No description provided for @hpAdd.
  ///
  /// In en, this message translates to:
  /// **'Add'**
  String get hpAdd;

  /// No description provided for @hpFamilyDashboard.
  ///
  /// In en, this message translates to:
  /// **'Family dashboard'**
  String get hpFamilyDashboard;

  /// No description provided for @hpNoFamilyYet.
  ///
  /// In en, this message translates to:
  /// **'No family members yet'**
  String get hpNoFamilyYet;

  /// No description provided for @hpAddExpense.
  ///
  /// In en, this message translates to:
  /// **'Add expense'**
  String get hpAddExpense;

  /// No description provided for @hpExpenseTracker.
  ///
  /// In en, this message translates to:
  /// **'Expense tracker'**
  String get hpExpenseTracker;

  /// No description provided for @hpByCategory.
  ///
  /// In en, this message translates to:
  /// **'By category'**
  String get hpByCategory;

  /// No description provided for @hpMonthly.
  ///
  /// In en, this message translates to:
  /// **'Monthly'**
  String get hpMonthly;

  /// No description provided for @hpMedicalRiskScore.
  ///
  /// In en, this message translates to:
  /// **'Medical risk score'**
  String get hpMedicalRiskScore;

  /// No description provided for @hpSmoking.
  ///
  /// In en, this message translates to:
  /// **'Smoking'**
  String get hpSmoking;

  /// No description provided for @hpAlcohol.
  ///
  /// In en, this message translates to:
  /// **'Alcohol'**
  String get hpAlcohol;

  /// No description provided for @hpFamilyHistory.
  ///
  /// In en, this message translates to:
  /// **'Family history'**
  String get hpFamilyHistory;

  /// No description provided for @hpCalculateRisk.
  ///
  /// In en, this message translates to:
  /// **'Calculate risk'**
  String get hpCalculateRisk;

  /// No description provided for @hpRiskLevel.
  ///
  /// In en, this message translates to:
  /// **'Level: {level} ({score})'**
  String hpRiskLevel(String level, String score);

  /// No description provided for @hpInsuranceAiChat.
  ///
  /// In en, this message translates to:
  /// **'Insurance AI Chat'**
  String get hpInsuranceAiChat;

  /// No description provided for @hpProtectionAnalytics.
  ///
  /// In en, this message translates to:
  /// **'Protection analytics'**
  String get hpProtectionAnalytics;

  /// No description provided for @hpScoreTrend.
  ///
  /// In en, this message translates to:
  /// **'Score trend'**
  String get hpScoreTrend;

  /// No description provided for @hpScorePoint.
  ///
  /// In en, this message translates to:
  /// **'Score {score}'**
  String hpScorePoint(String score);

  /// No description provided for @hpFamilyMembers.
  ///
  /// In en, this message translates to:
  /// **'Family members'**
  String get hpFamilyMembers;

  /// No description provided for @hpOccupation.
  ///
  /// In en, this message translates to:
  /// **'Occupation'**
  String get hpOccupation;

  /// No description provided for @hpCity.
  ///
  /// In en, this message translates to:
  /// **'City'**
  String get hpCity;

  /// No description provided for @hpMedicalConditions.
  ///
  /// In en, this message translates to:
  /// **'Medical conditions'**
  String get hpMedicalConditions;

  /// No description provided for @hpMonthlyBudget.
  ///
  /// In en, this message translates to:
  /// **'Monthly budget'**
  String get hpMonthlyBudget;

  /// No description provided for @hpAnalyzing.
  ///
  /// In en, this message translates to:
  /// **'Analyzing…'**
  String get hpAnalyzing;

  /// No description provided for @hpGetTopPlans.
  ///
  /// In en, this message translates to:
  /// **'Get top 5 plans'**
  String get hpGetTopPlans;

  /// No description provided for @hpWhyRecommended.
  ///
  /// In en, this message translates to:
  /// **'Why recommended'**
  String get hpWhyRecommended;

  /// No description provided for @hpPros.
  ///
  /// In en, this message translates to:
  /// **'Pros'**
  String get hpPros;

  /// No description provided for @hpCons.
  ///
  /// In en, this message translates to:
  /// **'Cons'**
  String get hpCons;

  /// No description provided for @hpEmergencyCard.
  ///
  /// In en, this message translates to:
  /// **'Emergency Card'**
  String get hpEmergencyCard;

  /// No description provided for @hpDigitalEmergencyCard.
  ///
  /// In en, this message translates to:
  /// **'Digital Emergency Card'**
  String get hpDigitalEmergencyCard;

  /// No description provided for @hpPdfShareHint.
  ///
  /// In en, this message translates to:
  /// **'PDF share works on mobile & desktop too'**
  String get hpPdfShareHint;

  /// No description provided for @hpBloodGroup.
  ///
  /// In en, this message translates to:
  /// **'Blood group'**
  String get hpBloodGroup;

  /// No description provided for @hpPolicyNumber.
  ///
  /// In en, this message translates to:
  /// **'Policy number'**
  String get hpPolicyNumber;

  /// No description provided for @hpInsuranceCompany.
  ///
  /// In en, this message translates to:
  /// **'Insurance company'**
  String get hpInsuranceCompany;
}
