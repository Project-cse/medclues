...
/// Health records hub — upload and manage personal medical documents.
...
class _RecordsScreenState extends ConsumerState<RecordsScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    // No nested Scaffold — DashboardShell already provides one.
    return SafeArea(
      child: Column(
        ...
        children: [
          ...
          Expanded(
            child: RefreshIndicator(
              ...
              onRefresh: () async {
                ref.invalidate(healthRecordsProvider);
                await ref.read(healthRecordsProvider.future);
              },
              child: _healthRecordsBody(l10n, records),
            ),
          ),
        ],
      ),
  ...
  Widget _healthRecordsBody(AppLocalizations l10n, AsyncValue<List<HealthRecordItem>> records) {
    return ListView(
      ...
      children: [
        ...
        records.when(
          ...
          error: (e, _) => _errorState(
            ...
            onRetry: () => ref.invalidate(healthRecordsProvider),
          ),
          data: (list) {
            if (list.isEmpty) {
              return _emptyState(
            ...
            return Column(
              children: list.map<Widget>((r) => _reportTile(r)).toList(),
            );
          },
        ),
      ],
