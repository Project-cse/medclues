  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final menu = [
      ...
      _MenuItem(
          ...
          RouteNames.savedProfiles),
      _MenuItem(
          Icons.payments_outlined,
          l10n.profilePayments,
      ...
      _MenuItem(
          ...
          RouteNames.emergencySettings),
      _MenuItem(Icons.help_outline, l10n.profileHelp, const Color(0xFF0EA5E9),
          const Color(0xFFEFF6FF), RouteNames.help),
    ];
